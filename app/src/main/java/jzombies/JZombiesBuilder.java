...
public class JZombiesBuilder implements ContextBuilder<Object> {
	...
	public String copy_folders_local_to_temp() {
        ...
        System.out.println("[GRADLE]This is Rui here");
        System.exit(0);
		System.out.println("**********************************************************************************************");
...
//        temp_destination = params.getString("output_path");
	    ...
	    String fileName_uav_speed = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator + "uav_speed" + ".csv";
	    String fileName_uav_communication = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator + "uav_communucation" + ".csv";
	    String fileName_uav_coordinate = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator + "uav_coordinate_reactive" + ".csv";
	    ...
	    String fileName_random_seed_report = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator + "random_seed_report" + ".csv";
	    String fileName_BS_coord = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "BS_coord" + ".csv";
	    String fileName_table = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "comm_table" + ".csv";
	    String fileName_SINR = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "uav_SINR" + ".csv";
	    String fileName_Throughput = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "uav_Throughput" + ".csv";
	    String fileName_Enb = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "bs_Enb" + ".csv";
...
//			PrintWriter writer_basestation_coord = new PrintWriter(new File(fileName_BS_coord));
...
//add Manned UAVs		
		try {
			if(if_load_mav) {
			uavs_list = read_manned(geography, if_straight, numberofruntime, mav_trajectory_type, mav_generation_rate, base_station_channels);
			}
			} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
...
//		UAVmanagement my_uav_management = new UAVmanagement(geography, fac, uavs_list, airport_list, terrain_start_location, terrain_end_location, numberofruntime, uav_generation_rate, if_straight, if_routing, simulation_time, current_random, base_station_channels);
...
//		add communication table
		...
		//////////////////////////////////////////////////////////////////
		//Add Block Zone
//		context.add(new Block_area(geography,(short)275, (short)305, (short)515, (short)590, 0, simulation_time));
//		context.add(new Block_area(geography,(short)50, (short)100, (short)500, (short)600, 0, simulation_time));
		//////////////////////////////////////////////////////////////////
...
//	                    ", Latitude= " + line.get(2) + " , Longitude=" + line.get(3)  + " , level=" + line.get(5) +"]");
		...
		UAV temp_uav = new UAV(geography,400, 18, if_straight, false, 0, 0, 0, true, "probability", null, numberofruntime, 1, true, 999, base_station_channels);
...
//							short basestation_x = (short) (distance2Coordinate(geography, -76.2597052, 43.0802922, -76.2597052, tmp.getCoordinate().y)  / (18));
//							short basestation_y = (short) (distance2Coordinate(geography, -76.2597052, 43.0802922, tmp.getCoordinate().x, 43.0802922)  / (18));
							double basestation_x = distance2Coordinate(geography, 48.0802922, -103.2597052,  48.0802922, tmp.getCoordinate().x);
							double basestation_y = distance2Coordinate(geography, 48.0802922, -103.2597052,  tmp.getCoordinate().y,  -103.2597052);
							
							
							String TMP_fileName_BS_coord = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "BS_coord" + ".csv";
					    	
//							String TMP_fileName_BS_coord =temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "BS_coord" + ".csv";
							try {
								PrintWriter TMP_writer_BS_coord = new PrintWriter(new FileOutputStream(new File(TMP_fileName_BS_coord),true));
					//			PrintWriter writer_BS_coord = new PrintWriter(new File(TMP_fileName_BS_coord));
...
////			short basestation_x = (short) (distance2Coordinate(geography, -76.2597052, 43.0802922, -76.2597052, tmp.getCoordinate().y)  / (18));
////			short basestation_y = (short) (distance2Coordinate(geography, -76.2597052, 43.0802922, tmp.getCoordinate().x, 43.0802922)  / (18));
//			double basestation_x = distance2Coordinate(geography, 43.0802922, -76.2597052,  43.0802922, tmp.getCoordinate().x);
//			double basestation_y = distance2Coordinate(geography, 43.0802922, -76.2597052,  tmp.getCoordinate().y,  -76.2597052);
//			
//			
//			String TMP_fileName_BS_coord = temp_destination + File.separator + "report" + File.separator + "batch_" + Integer.toString(numberofruntime) + File.separator +  "BS_coord" + ".csv";
//	    	
...
//////////////////////////////////////////////////////////////////
    ...
    public ArrayList<UAV> read_manned(Geography<Object> geography, boolean if_straight, int current_batch, String mav_trajectory_type, int mav_generation_rate, long base_station_channels) throws FileNotFoundException {
    	ArrayList<UAV> uavs_list = new ArrayList<UAV>();
...
//        Scanner scanner = new Scanner(new File(temp_pre_fix + File.separator + "configuration" + File.separator + "operation.csv"));
        Scanner scanner = new Scanner(new File(temp_pre_fix + File.separator + "configuration" + File.separator + "mav_"+mav_trajectory_type+"_"+mav_generation_rate+".csv"));
        scanner.useDelimiter(",");
        // remove the first line
        if(scanner.hasNext()) {
            scanner.nextLine();
...
//                    ", Latitude= " + line.get(2) + " , Longitude=" + line.get(3)  + " , level=" + line.get(5) +"]");
        	...
        	if(uavs_list.isEmpty()) {
				...
				UAV temp_uav = new UAV(geography,400, speed, if_straight, false, Integer.valueOf(line.get(0)), 0, 0, true, "probability", null, current_batch, level, false, id, base_station_channels);
...
//        
	...
	public ArrayList<UAV> read_operation(Geography<Object> geography, boolean if_straight, int current_batch, long base_station_channels) throws FileNotFoundException {
    	ArrayList<UAV> uavs_list = new ArrayList<UAV>();
...
//        		System.out.println("Empty add");
				start_coordinate_pair.add(Double.valueOf(line.get(3)));
				start_coordinate_pair.add(Double.valueOf(line.get(2)));
				UAV temp_uav = new UAV(geography,400, 18, if_straight, false, Integer.valueOf(line.get(0)), 0, 0, true, "probability", null, current_batch, level, true, id, base_station_channels);
				temp_uav.set_internal_time(Integer.valueOf(line.get(0)));
		        temp_uav.set_start_coordinate_pair(start_coordinate_pair);
				uavs_list.add(temp_uav);
				temp_uav.CreatSocket(start_coordinate_pair.get(1), start_coordinate_pair.get(0));
...
//        				}
	...
	void record_random_seed(int current_batch, int random_seed) {
	    ...
	    String uav_count_report = temp_pre_fix + File.separator + "report" + File.separator +  "batch_" + Integer.toString(current_batch) + File.separator + "random_seed_report" + ".csv";
	    StringBuilder uav_count_report_string = new StringBuilder();
